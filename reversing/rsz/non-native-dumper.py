...
def generate_field_entries(il2cpp_dump, natives, key, il2cpp_entry, use_typedefs, prefix = "", i=0, struct_i=0, unpack_struct=True):
    ...
    for _ in range(0, max_parent_level):
        ...
        # if rsz inside parent, it already inside the current types.
...
if __name__ == '__main__':
    fire.Fire(main)
    # python non-native-dumper.py mhwilds il2cpp_dump.json native_layouts_MonsterHunterWilds_dump.exe.json False True False True hardcode_native_rsz.json,hardcode_native_rsz_change_layout.json hardcode_native_layout.json